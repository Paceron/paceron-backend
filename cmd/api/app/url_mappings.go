...
func mapUrls(r *gin.Engine, app *Application) {
	...
	r.POST("/api/v1/users/:id/entrenador-role", app.userRoleController.ActivateEntrenador)
	r.DELETE("/api/v1/users/:id/entrenador-role", app.userRoleController.DeactivateEntrenador)
