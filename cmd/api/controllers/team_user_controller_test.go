...
type mockTeamUserService struct {
	addUserFn       func(ctx *gin.Context, teamID int64, req *teamuser.AddTeamUserRequest) (*teamuser.TeamUserResponse, error)
	removeUserFn    func(ctx *gin.Context, teamID, userID int64) error
	getUsersByTeamFn func(ctx *gin.Context, teamID int64) ([]teamuser.TeamUserResponse, error)
}

func (m *mockTeamUserService) AddUser(ctx *gin.Context, teamID int64, req *teamuser.AddTeamUserRequest) (*teamuser.TeamUserResponse, error) {
	if m.addUserFn != nil {
		return m.addUserFn(ctx, teamID, req)
	}
	return nil, nil
}

func (m *mockTeamUserService) RemoveUser(ctx *gin.Context, teamID, userID int64) error {
