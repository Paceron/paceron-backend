...
type mockGroupUserService struct {
	addUserFn        func(ctx *gin.Context, teamID, groupID int64, req *groupuser.AddGroupUserRequest) (*groupuser.GroupUserResponse, error)
	removeUserFn     func(ctx *gin.Context, groupID, userID int64) error
	getUsersByGroupFn func(ctx *gin.Context, groupID int64) ([]groupuser.GroupUserResponse, error)
}

func (m *mockGroupUserService) AddUser(ctx *gin.Context, teamID, groupID int64, req *groupuser.AddGroupUserRequest) (*groupuser.GroupUserResponse, error) {
	if m.addUserFn != nil {
		return m.addUserFn(ctx, teamID, groupID, req)
	}
	return nil, nil
}

func (m *mockGroupUserService) RemoveUser(ctx *gin.Context, groupID, userID int64) error {
	if m.removeUserFn != nil {
		return m.removeUserFn(ctx, groupID, userID)
	}
	return nil
}
