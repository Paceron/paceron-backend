...
func (m *mockTeamServiceForDelegate) Create(ctx *gin.Context, req *team.CreateTeamRequest) (*team.TeamResponse, error) {
	if m.createFn != nil {
		return m.createFn(ctx, req)
	}
	return nil, nil
}
func (m *mockTeamServiceForDelegate) Update(ctx *gin.Context, id int64, req *team.UpdateTeamRequest) (*team.TeamResponse, error) {
	return nil, nil
}
...
func (m *mockTeamServiceForDelegate) UpdateAddress(ctx *gin.Context, id int64, req *team.UpdateTeamAddressRequest) (*team.TeamResponse, error) {
	return nil, nil
}
...
func (m *mockGroupServiceForDelegate) Create(ctx *gin.Context, req *group.CreateGroupRequest) (*group.GroupResponse, error) {
	m.createCalled = true
	m.lastCreateReq = req
	if m.createFn != nil {
		return m.createFn(ctx, req)
...
func (m *mockGroupServiceForDelegate) Update(ctx *gin.Context, id int64, req *group.UpdateGroupRequest) (*group.GroupResponse, error) {
	return nil, nil
}
...
func TestTeamDelegate_CreateTeam_CreatesDefaultGroupWhenFlagOmitted(t *testing.T) {
	...
	_, err := d.CreateTeam(nil, &team.CreateTeamRequest{Name: "Equipo Alpha"})
...
func TestTeamDelegate_CreateTeam_CreatesDefaultGroupWhenTrue(t *testing.T) {
	...
	d := NewTeamDelegate(teamSvc, groupSvc)
	createDefault := true
	_, err := d.CreateTeam(nil, &team.CreateTeamRequest{Name: "Equipo Alpha", CreateDefaultGroup: &createDefault})
